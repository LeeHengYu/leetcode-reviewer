import { Difficulty } from "../stores/QuestionFilterStore"
...
const tableData: Question[] = [
  ...
  },
  {
    ...
    category: "Backtracking",
    difficulty: "Medium",
    solution: "maximum-length-of-a-concatenated-string-with-unique-characters.py",
    dailyChallenge: new Date("2024-01-23"),
  },
];
